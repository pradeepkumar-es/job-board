...
export function JobToolbar({handleJobSearch, handleSort, sortOrder}){
    return (
        <div className={Styles.jobToolbar}>
            <div className={Styles.jobSearch}>
              <span> <img src={searchIcon} alt="search icon" /></span> <input placeholder="Search jobs, companies,..." type="text" onChange = {(e)=>handleJobSearch(e)} />
            </div>
